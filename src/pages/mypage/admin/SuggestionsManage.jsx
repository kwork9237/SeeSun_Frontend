    ...
    <div className="min-h-screen flex flex-col bg-white text-gray-800 font-sans">
      ...
      <div className="flex flex-1 pt-16">
        ...
        <main className="flex-1 ml-64 p-10 bg-white">
          <h1 className="text-2xl font-bold mb-6">건의 사항 관리 (게시판 형식)</h1>

          {/* 게시판 테이블 영역 */}
          <div className="border border-gray-300 rounded-lg min-h-[500px] flex flex-col shadow-sm">
            
            {/* 테이블 헤더 */}
            {/* grid-cols-[...] 를 사용하여 원본의 비율(1:2:7:2)을 그대로 유지 */}
            <div className="grid grid-cols-[1fr_2fr_7fr_2fr] gap-4 border-b border-gray-300 p-4 font-bold text-lg bg-white rounded-t-lg items-center">
              <div>NO</div>
              <div>구분</div>
              <div>건의 사유</div>
              <div className="text-right">건의자</div>
            </div>

            {/* 테이블 바디 (내용 없음) */}
            <div className="flex-1 p-6 text-gray-600 font-medium text-lg">
