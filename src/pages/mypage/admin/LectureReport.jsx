    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: colors.white, color: colors.textMain, fontFamily: 'sans-serif' }}>
      ...
      <div style={{ display: 'flex', flex: 1, paddingTop: '64px' }}>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <li style={{
                  ...
                  fontSize: '0.875rem',
                  fontWeight: 'bold',
                  backgroundColor: colors.bgLight, // 활성화 배경색
                  cursor: 'pointer'
                }}>
                  강의 신고 관리 (요청 기능 N)
                </li>
        ...
        <main style={{ flex: 1, marginLeft: '256px', padding: '40px', backgroundColor: colors.white }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '24px' }}>강의 신고 관리 (게시판 형식)</h1>
          ...
          <div style={{
            ...
            <div style={{
              display: 'grid',
              gridTemplateColumns: '0.5fr 1fr 3fr 3fr 1fr', // 비율 조정 (NO, 구분, 대상, 사유, 신고자)
              gap: '16px',
              ...
              <div>신고 대상 (강의 제목)</div>
              <div>신고 사유</div>
              <div style={{ textAlign: 'right' }}>신고자</div>
            </div>

            {/* 테이블 본문 (텍스트 설명) */}
            <div style={{ flex: 1, padding: '24px', color: colors.textMain, fontSize: '1.125rem', lineHeight: '1.8' }}>
              <p>신고 접수된 강의 리스트</p>
