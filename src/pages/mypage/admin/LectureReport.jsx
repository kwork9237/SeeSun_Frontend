...
const Icons = {
  ...
  Siren: () => (
    ...
    >
      ...
      <path d="M4 2C4 2 5 5 5 5C5 5 2 7 2 7C2 7 5 5 5 5C5 5 4 2 4 2Z" />
      <path d="M20 2C20 2 19 5 19 5C19 5 22 7 22 7C22 7 19 5 19 5C19 5 20 2 20 2Z" />
    </svg>
  ),
  MessageSquare: () => (
    <svg
        ...
        <aside className="w-64 bg-white fixed left-0 top-16 h-[calc(100vh-64px)] overflow-y-auto z-10 flex flex-col pt-8 px-6 border-r border-gray-100">
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-bold text-[#FF6B4A] bg-[#FFF0EB] px-2 py-0.5 rounded-sm w-fit mt-1">
                MASTER
              </span>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-1">
                <Link
                  ...
                  className="flex items-center gap-3 px-3 py-2.5 bg-[#FFF7ED] text-[#FF6B4A] rounded-lg transition-colors"
                >
