        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link to="/lecture" className="hover:text-primary transition">강의 찾기</Link></li>
              {/* 통합 대시보드(마이페이지)로 연결 */}
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              {/* 멘토 지원/가입 페이지(Mento) */}
              <li>
                <Link to="/join" className="text-white font-bold hover:text-secondary transition flex items-center gap-2">
